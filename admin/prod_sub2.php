 ...
 */
    ...
    class prod_sub2Page extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('idSub1', 'prod_sub1', new IntegerField('idSub1', null, null, true), new StringField('NombreSub1', 'idSub1_NombreSub1', 'idSub1_NombreSub1_prod_sub1'), 'idSub1_NombreSub1_prod_sub1');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('prod_sub2ssearch', $this->dataset,
                array('idSub2', 'NombreSub2', 'idSub1_NombreSub1'),
                array($this->RenderText('IdSub2'), $this->RenderText('NombreSub2'), $this->RenderText('IdSub1')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('prod_sub2asearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idSub2', $this->RenderText('IdSub2')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('NombreSub2', $this->RenderText('NombreSub2')));
            ...
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, false);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('idSub1', $this->RenderText('IdSub1'), $lookupDataset, 'idSub1', 'NombreSub1', false));
        }
        ...
        {
            //
            // View column for idSub2 field
            //
            $column = new TextViewColumn('idSub2', 'IdSub2', $this->dataset);
            ...
            //
            $column = new TextViewColumn('NombreSub2', 'NombreSub2', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('NombreSub2_handler');
            
            /* <inline edit column> */
            //
            // Edit column for NombreSub2 field
            //
            $editor = new TextAreaEdit('nombresub2_edit', 50, 8);
            $editColumn = new CustomEditColumn('NombreSub2', 'NombreSub2', $editor, $this->dataset);
            ...
            //
            $column = new TextViewColumn('idSub1_NombreSub1', 'IdSub1', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for idSub1 field
            //
            $editor = new ComboBox('idsub1_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $lookupDataset = new TableDataset(
                new MyConnectionFactory(),
                GetConnectionOptions(),
                '`prod_sub1`');
            ...
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, false);
            $lookupDataset->SetOrderBy('NombreSub1', GetOrderTypeAsSQL(otAscending));
        ...
        {
            $result = new Grid($this, $this->dataset, 'prod_sub2Grid');
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'NombreSub2_handler', $column);
    ...
    try
    {
        $Page = new prod_sub2Page("prod_sub2.php", "prod_sub2", GetCurrentUserGrantForDataSource("prod_sub2"), 'UTF-8');
        $Page->SetShortCaption('Prod Sub2');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Prod Sub2');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("prod_sub2"));
