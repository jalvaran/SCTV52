 ...
 */
    ...
    class comisionesporventasPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`comisionesporventas`');
            $field = new IntegerField('idComisionesPorVentas', null, null, true);
            ...
            $this->dataset->AddField($field, false);
            $field = new StringField('TipoVenta');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('Colaboradores_idColaboradores');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new IntegerField('Ventas_NumVenta');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('comisionesporventasssearch', $this->dataset,
                array('idComisionesPorVentas', 'CuentaPUC', 'NombreCuenta', 'Fecha', 'Valor', 'TipoVenta', 'Colaboradores_idColaboradores', 'Ventas_NumVenta', 'Paga'),
                array($this->RenderText('IdComisionesPorVentas'), $this->RenderText('CuentaPUC'), $this->RenderText('NombreCuenta'), $this->RenderText('Fecha'), $this->RenderText('Valor'), $this->RenderText('TipoVenta'), $this->RenderText('Colaboradores IdColaboradores'), $this->RenderText('Ventas NumVenta'), $this->RenderText('Paga')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('comisionesporventasasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idComisionesPorVentas', $this->RenderText('IdComisionesPorVentas')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('TipoVenta', $this->RenderText('TipoVenta')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('Colaboradores_idColaboradores', $this->RenderText('Colaboradores IdColaboradores')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('Ventas_NumVenta', $this->RenderText('Ventas NumVenta')));
        ...
        {
            //
            // View column for idComisionesPorVentas field
            //
            $column = new TextViewColumn('idComisionesPorVentas', 'IdComisionesPorVentas', $this->dataset);
            ...
            //
            // View column for TipoVenta field
            //
            $column = new TextViewColumn('TipoVenta', 'TipoVenta', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for TipoVenta field
            //
            $editor = new TextEdit('tipoventa_edit');
            $editor->SetSize(45);
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('TipoVenta', 'TipoVenta', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
            ...
            //
            // View column for Colaboradores_idColaboradores field
            //
            $column = new TextViewColumn('Colaboradores_idColaboradores', 'Colaboradores IdColaboradores', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for Colaboradores_idColaboradores field
            //
            $editor = new TextEdit('colaboradores_idcolaboradores_edit');
            $editColumn = new CustomEditColumn('Colaboradores IdColaboradores', 'Colaboradores_idColaboradores', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            ...
            //
            // View column for Ventas_NumVenta field
            //
            $column = new TextViewColumn('Ventas_NumVenta', 'Ventas NumVenta', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for Ventas_NumVenta field
            //
            $editor = new TextEdit('ventas_numventa_edit');
            $editColumn = new CustomEditColumn('Ventas NumVenta', 'Ventas_NumVenta', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
        ...
        {
            $result = new Grid($this, $this->dataset, 'comisionesporventasGrid');
    ...
    try
    {
        $Page = new comisionesporventasPage("comisionesporventas.php", "comisionesporventas", GetCurrentUserGrantForDataSource("comisionesporventas"), 'UTF-8');
        $Page->SetShortCaption('Comisionesporventas');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Comisionesporventas');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("comisionesporventas"));
