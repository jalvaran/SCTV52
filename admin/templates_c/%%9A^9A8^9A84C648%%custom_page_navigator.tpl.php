...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escapeurl', 'list/custom_page_navigator.tpl', 9, false),)), $this); ?>
<div class="pgui-pagination">
    <div class="pagination">
        <ul><?php echo '<li class="disabled"><a>'; ?><?php echo $this->_tpl_vars['PageNavigator']->GetCaption(); ?><?php echo ':</a></li>'; ?>
