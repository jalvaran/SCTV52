 ...
 */
    ...
    class facturas_abonosPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('facturas_abonosssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('facturas_abonosasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        {
            $result = new Grid($this, $this->dataset, 'facturas_abonosGrid');
    ...
    try
    {
        $Page = new facturas_abonosPage("facturas_abonos.php", "facturas_abonos", GetCurrentUserGrantForDataSource("facturas_abonos"), 'UTF-8');
        $Page->SetShortCaption('Facturas Abonos');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Facturas Abonos');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("facturas_abonos"));
