 ...
 */
    ...
    class relacioncomprasPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('relacioncomprasssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('relacioncomprasasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        {
            $result = new Grid($this, $this->dataset, 'relacioncomprasGrid');
    ...
    try
    {
        $Page = new relacioncomprasPage("relacioncompras.php", "relacioncompras", GetCurrentUserGrantForDataSource("relacioncompras"), 'UTF-8');
        $Page->SetShortCaption('Relacioncompras');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Relacioncompras');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("relacioncompras"));
