 ...
 */
    ...
    class empresaproPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`empresapro`');
            $field = new IntegerField('idEmpresaPro', null, null, true);
            ...
            $this->dataset->AddField($field, false);
            $field = new StringField('ResolucionDian');
            $this->dataset->AddField($field, false);
            $field = new StringField('Email');
            $this->dataset->AddField($field, false);
            $field = new StringField('WEB');
            $this->dataset->AddField($field, false);
            $field = new StringField('PuntoEquilibrio');
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('empresaprossearch', $this->dataset,
                array('idEmpresaPro', 'RazonSocial', 'NIT', 'Direccion', 'Telefono', 'Celular', 'Ciudad', 'ResolucionDian', 'Email', 'WEB', 'PuntoEquilibrio'),
                array($this->RenderText('IdEmpresaPro'), $this->RenderText('RazonSocial'), $this->RenderText('NIT'), $this->RenderText('Direccion'), $this->RenderText('Telefono'), $this->RenderText('Celular'), $this->RenderText('Ciudad'), $this->RenderText('ResolucionDian'), $this->RenderText('Email'), $this->RenderText('WEB'), $this->RenderText('PuntoEquilibrio')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('empresaproasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idEmpresaPro', $this->RenderText('IdEmpresaPro')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('ResolucionDian', $this->RenderText('ResolucionDian')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('WEB', $this->RenderText('WEB')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('PuntoEquilibrio', $this->RenderText('PuntoEquilibrio')));
        }
        ...
        {
            //
            // View column for idEmpresaPro field
            //
            $column = new TextViewColumn('idEmpresaPro', 'IdEmpresaPro', $this->dataset);
            ...
            //
            // View column for ResolucionDian field
            //
            $column = new TextViewColumn('ResolucionDian', 'ResolucionDian', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('ResolucionDian_handler');
            
            /* <inline edit column> */
            //
            // Edit column for ResolucionDian field
            //
            $editor = new TextAreaEdit('resoluciondian_edit', 50, 8);
            $editColumn = new CustomEditColumn('ResolucionDian', 'ResolucionDian', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
            ...
            //
            $column = new TextViewColumn('WEB', 'WEB', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            // View column for PuntoEquilibrio field
            //
            $column = new TextViewColumn('PuntoEquilibrio', 'PuntoEquilibrio', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for PuntoEquilibrio field
            //
            $editor = new TextEdit('puntoequilibrio_edit');
            $editor->SetSize(45);
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('PuntoEquilibrio', 'PuntoEquilibrio', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
        ...
        {
            $result = new Grid($this, $this->dataset, 'empresaproGrid');
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'ResolucionDian_handler', $column);
    ...
    try
    {
        $Page = new empresaproPage("empresapro.php", "empresapro", GetCurrentUserGrantForDataSource("empresapro"), 'UTF-8');
        $Page->SetShortCaption('Empresapro');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Empresapro');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("empresapro"));
