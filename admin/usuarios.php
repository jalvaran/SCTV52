    ...
    class usuariosPage extends Page
    {
        ...
        protected function CreateGridSearchControl(Grid $grid)
        {
            ...
            $grid->SearchControl = new SimpleSearch('usuariosssearch', $this->dataset,
                array('idUsuarios', 'Nombre', 'Apellido', 'Identificacion', 'Telefono', 'Login', 'TipoUser', 'Email', 'FechaCreacion'),
                array($this->RenderText('IdUsuarios'), $this->RenderText('Nombre'), $this->RenderText('Apellido'), $this->RenderText('Identificacion'), $this->RenderText('Telefono'), $this->RenderText('Login'), $this->RenderText('TipoUser'), $this->RenderText('Email'), $this->RenderText('FechaCreacion')),
                array(
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idUsuarios', $this->RenderText('IdUsuarios')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('Apellido', $this->RenderText('Apellido')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('TipoUser', $this->RenderText('TipoUser')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateDateTimeSearchInput('FechaCreacion', $this->RenderText('FechaCreacion')));
        }
        ...
        {
            //
            // View column for idUsuarios field
            //
            $column = new TextViewColumn('idUsuarios', 'IdUsuarios', $this->dataset);
            ...
            //
            $column = new TextViewColumn('Apellido', 'Apellido', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            // View column for TipoUser field
            //
            $column = new TextViewColumn('TipoUser', 'TipoUser', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for TipoUser field
            //
            $editor = new ComboBox('tipouser_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $editor->AddValue('administrador', $this->RenderText('administrador'));
            $editor->AddValue('operador', $this->RenderText('operador'));
            $editor->AddValue('normal', $this->RenderText('normal'));
            $editColumn = new CustomEditColumn('TipoUser', 'TipoUser', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            ...
            //
            // View column for FechaCreacion field
            //
            $column = new DateTimeViewColumn('FechaCreacion', 'FechaCreacion', $this->dataset);
            $column->SetDateTimeFormat('Y-m-d H:i:s');
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for FechaCreacion field
            //
            $editor = new DateTimeEdit('fechacreacion_edit', true, 'Y-m-d H:i:s', GetFirstDayOfWeek());
            $editColumn = new CustomEditColumn('FechaCreacion', 'FechaCreacion', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
