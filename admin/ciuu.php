 ...
 */
    ...
    class ciuuPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('ciuussearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('ciuuasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        {
            $result = new Grid($this, $this->dataset, 'ciuuGrid');
    ...
    try
    {
        $Page = new ciuuPage("ciuu.php", "ciuu", GetCurrentUserGrantForDataSource("ciuu"), 'UTF-8');
        $Page->SetShortCaption('Ciuu');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Ciuu');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("ciuu"));
