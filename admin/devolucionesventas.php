 ...
 */
    ...
    class devolucionesventasPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`devolucionesventas`');
            $field = new IntegerField('idComprasDevoluciones', null, null, true);
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new StringField('NumVenta');
            ...
            $this->dataset->AddField($field, false);
            $field = new StringField('EfectivoDevuelto');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('devolucionesventasssearch', $this->dataset,
                array('idComprasDevoluciones', 'NumVenta', 'Fecha', 'Descripcion', 'Cantidad', 'EfectivoDevuelto', 'ProductosVenta_idProductosVenta'),
                array($this->RenderText('IdComprasDevoluciones'), $this->RenderText('NumVenta'), $this->RenderText('Fecha'), $this->RenderText('Descripcion'), $this->RenderText('Cantidad'), $this->RenderText('EfectivoDevuelto'), $this->RenderText('ProductosVenta IdProductosVenta')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('devolucionesventasasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idComprasDevoluciones', $this->RenderText('IdComprasDevoluciones')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('NumVenta', $this->RenderText('NumVenta')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('EfectivoDevuelto', $this->RenderText('EfectivoDevuelto')));
        ...
        {
            //
            // View column for idComprasDevoluciones field
            //
            $column = new TextViewColumn('idComprasDevoluciones', 'IdComprasDevoluciones', $this->dataset);
            ...
            //
            // View column for NumVenta field
            //
            $column = new TextViewColumn('NumVenta', 'NumVenta', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for NumVenta field
            //
            $editor = new TextEdit('numventa_edit');
            $editor->SetSize(45);
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('NumVenta', 'NumVenta', $editor, $this->dataset);
            ...
            //
            // View column for EfectivoDevuelto field
            //
            $column = new TextViewColumn('EfectivoDevuelto', 'EfectivoDevuelto', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for EfectivoDevuelto field
            //
            $editor = new TextEdit('efectivodevuelto_edit');
            $editor->SetSize(45);
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('EfectivoDevuelto', 'EfectivoDevuelto', $editor, $this->dataset);
        ...
        {
            $result = new Grid($this, $this->dataset, 'devolucionesventasGrid');
    ...
    try
    {
        $Page = new devolucionesventasPage("devolucionesventas.php", "devolucionesventas", GetCurrentUserGrantForDataSource("devolucionesventas"), 'UTF-8');
        $Page->SetShortCaption('Devolucionesventas');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Devolucionesventas');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("devolucionesventas"));
