 ...
 */
    ...
    class comprasPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`compras`');
            $field = new IntegerField('idCompras', null, null, true);
            ...
            $this->dataset->AddField($field, false);
            $field = new StringField('Retenciones');
            $this->dataset->AddField($field, false);
            $field = new StringField('Total');
            $this->dataset->AddField($field, false);
            $field = new StringField('TipoPago');
            $this->dataset->AddField($field, false);
            $field = new StringField('Pagada');
            $this->dataset->AddField($field, false);
            $field = new IntegerField('Proveedores_idProveedores');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('comprasssearch', $this->dataset,
                array('idCompras', 'CuentaPUC', 'Fecha', 'Descripcion', 'NumFactura', 'Subtotal', 'IVA', 'Retenciones', 'Total', 'TipoPago', 'Pagada', 'Proveedores_idProveedores'),
                array($this->RenderText('IdCompras'), $this->RenderText('CuentaPUC'), $this->RenderText('Fecha'), $this->RenderText('Descripcion'), $this->RenderText('NumFactura'), $this->RenderText('Subtotal'), $this->RenderText('IVA'), $this->RenderText('Retenciones'), $this->RenderText('Total'), $this->RenderText('TipoPago'), $this->RenderText('Pagada'), $this->RenderText('Proveedores IdProveedores')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('comprasasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idCompras', $this->RenderText('IdCompras')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('Retenciones', $this->RenderText('Retenciones')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('TipoPago', $this->RenderText('TipoPago')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('Pagada', $this->RenderText('Pagada')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('Proveedores_idProveedores', $this->RenderText('Proveedores IdProveedores')));
        }
        ...
        {
            //
            // View column for idCompras field
            //
            $column = new TextViewColumn('idCompras', 'IdCompras', $this->dataset);
            ...
            //
            // View column for Retenciones field
            //
            $column = new TextViewColumn('Retenciones', 'Retenciones', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for Retenciones field
            //
            $editor = new TextEdit('retenciones_edit');
            $editor->SetSize(45);
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('Retenciones', 'Retenciones', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
            ...
            //
            // View column for TipoPago field
            //
            $column = new TextViewColumn('TipoPago', 'TipoPago', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for TipoPago field
            //
            $editor = new TextEdit('tipopago_edit');
            $editor->SetSize(45);
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('TipoPago', 'TipoPago', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
            ...
            //
            // View column for Pagada field
            //
            $column = new TextViewColumn('Pagada', 'Pagada', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for Pagada field
            //
            $editor = new TextEdit('pagada_edit');
            $editor->SetSize(45);
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('Pagada', 'Pagada', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
            ...
            //
            // View column for Proveedores_idProveedores field
            //
            $column = new TextViewColumn('Proveedores_idProveedores', 'Proveedores IdProveedores', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for Proveedores_idProveedores field
            //
            $editor = new TextEdit('proveedores_idproveedores_edit');
            $editColumn = new CustomEditColumn('Proveedores IdProveedores', 'Proveedores_idProveedores', $editor, $this->dataset);
        ...
        {
            $result = new Grid($this, $this->dataset, 'comprasGrid');
    ...
    try
    {
        $Page = new comprasPage("compras.php", "compras", GetCurrentUserGrantForDataSource("compras"), 'UTF-8');
        $Page->SetShortCaption('Compras');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Compras');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("compras"));
