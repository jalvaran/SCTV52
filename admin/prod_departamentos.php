 ...
 */
    ...
    class prod_departamentosPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('prod_departamentosssearch', $this->dataset,
                array('idDepartamentos', 'Nombre'),
                array($this->RenderText('IdDepartamentos'), $this->RenderText('Nombre')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('prod_departamentosasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idDepartamentos', $this->RenderText('IdDepartamentos')));
        ...
        {
            //
            // View column for idDepartamentos field
            //
            $column = new TextViewColumn('idDepartamentos', 'IdDepartamentos', $this->dataset);
        ...
        {
            $result = new Grid($this, $this->dataset, 'prod_departamentosGrid');
    ...
    try
    {
        $Page = new prod_departamentosPage("prod_departamentos.php", "prod_departamentos", GetCurrentUserGrantForDataSource("prod_departamentos"), 'UTF-8');
        $Page->SetShortCaption('Prod Departamentos');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Prod Departamentos');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("prod_departamentos"));
