 ...
 */
    ...
    class libromayorbalancesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`libromayorbalances`');
            $field = new IntegerField('idLibroMayorBalances', null, null, true);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('libromayorbalancesssearch', $this->dataset,
                array('idLibroMayorBalances', 'Fecha', 'CuentaPUC', 'NombreCuenta', 'Debito', 'Credito'),
                array($this->RenderText('IdLibroMayorBalances'), $this->RenderText('Fecha'), $this->RenderText('CuentaPUC'), $this->RenderText('NombreCuenta'), $this->RenderText('Debito'), $this->RenderText('Credito')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('libromayorbalancesasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idLibroMayorBalances', $this->RenderText('IdLibroMayorBalances')));
        ...
        {
            //
            // View column for idLibroMayorBalances field
            //
            $column = new TextViewColumn('idLibroMayorBalances', 'IdLibroMayorBalances', $this->dataset);
        ...
        {
            $result = new Grid($this, $this->dataset, 'libromayorbalancesGrid');
    ...
    try
    {
        $Page = new libromayorbalancesPage("libromayorbalances.php", "libromayorbalances", GetCurrentUserGrantForDataSource("libromayorbalances"), 'UTF-8');
        $Page->SetShortCaption('Libromayorbalances');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Libromayorbalances');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("libromayorbalances"));
