 ...
 */
    ...
    class remisionesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`remisiones`');
            $field = new IntegerField('idRemisiones', null, null, true);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('remisionesssearch', $this->dataset,
                array('idRemisiones', 'Fecha', 'Cliente', 'Observaciones', 'Cotizaciones_idCotizaciones'),
                array($this->RenderText('IdRemisiones'), $this->RenderText('Fecha'), $this->RenderText('Cliente'), $this->RenderText('Observaciones'), $this->RenderText('Cotizaciones IdCotizaciones')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('remisionesasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idRemisiones', $this->RenderText('IdRemisiones')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('Cliente', $this->RenderText('Cliente')));
        ...
        {
            //
            // View column for idRemisiones field
            //
            $column = new TextViewColumn('idRemisiones', 'IdRemisiones', $this->dataset);
            ...
            //
            $column = new TextViewColumn('Cliente', 'Cliente', $this->dataset);
            $column->SetOrderable(true);
        ...
        {
            $result = new Grid($this, $this->dataset, 'remisionesGrid');
    ...
    try
    {
        $Page = new remisionesPage("remisiones.php", "remisiones", GetCurrentUserGrantForDataSource("remisiones"), 'UTF-8');
        $Page->SetShortCaption('Remisiones');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Remisiones');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("remisiones"));
