 ...
 */
    ...
    class cod_documentosPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('cod_documentosssearch', $this->dataset,
                array('Codigo', 'Descripcion'),
                array($this->RenderText('Codigo'), $this->RenderText('Descripcion')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('cod_documentosasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        {
            $result = new Grid($this, $this->dataset, 'cod_documentosGrid');
    ...
    try
    {
        $Page = new cod_documentosPage("cod_documentos.php", "cod_documentos", GetCurrentUserGrantForDataSource("cod_documentos"), 'UTF-8');
        $Page->SetShortCaption('Cod Documentos');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Cod Documentos');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("cod_documentos"));
