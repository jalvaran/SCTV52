 ...
 */
    ...
    class prod_sub3Page extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('idSub2', 'prod_sub2', new IntegerField('idSub2', null, null, true), new StringField('NombreSub2', 'idSub2_NombreSub2', 'idSub2_NombreSub2_prod_sub2'), 'idSub2_NombreSub2_prod_sub2');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('prod_sub3ssearch', $this->dataset,
                array('idSub3', 'NombreSub3', 'idSub2_NombreSub2'),
                array($this->RenderText('IdSub3'), $this->RenderText('NombreSub3'), $this->RenderText('IdSub2')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('prod_sub3asearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idSub3', $this->RenderText('IdSub3')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('NombreSub3', $this->RenderText('NombreSub3')));
            ...
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, false);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('idSub2', $this->RenderText('IdSub2'), $lookupDataset, 'idSub2', 'NombreSub2', false));
        }
        ...
        {
            //
            // View column for idSub3 field
            //
            $column = new TextViewColumn('idSub3', 'IdSub3', $this->dataset);
            ...
            //
            $column = new TextViewColumn('NombreSub3', 'NombreSub3', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('NombreSub3_handler');
            
            /* <inline edit column> */
            //
            // Edit column for NombreSub3 field
            //
            $editor = new TextAreaEdit('nombresub3_edit', 50, 8);
            $editColumn = new CustomEditColumn('NombreSub3', 'NombreSub3', $editor, $this->dataset);
            ...
            //
            $column = new TextViewColumn('idSub2_NombreSub2', 'IdSub2', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for idSub2 field
            //
            $editor = new ComboBox('idsub2_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $lookupDataset = new TableDataset(
                new MyConnectionFactory(),
                GetConnectionOptions(),
                '`prod_sub2`');
            ...
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, false);
            $lookupDataset->SetOrderBy('NombreSub2', GetOrderTypeAsSQL(otAscending));
        ...
        {
            $result = new Grid($this, $this->dataset, 'prod_sub3Grid');
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'NombreSub3_handler', $column);
    ...
    try
    {
        $Page = new prod_sub3Page("prod_sub3.php", "prod_sub3", GetCurrentUserGrantForDataSource("prod_sub3"), 'UTF-8');
        $Page->SetShortCaption('Prod Sub3');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Prod Sub3');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("prod_sub3"));
