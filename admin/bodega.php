 ...
 */
    ...
    class bodegaPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('bodegassearch', $this->dataset,
                array('idBodega', 'Nombre', 'Direccion', 'Ciudad', 'Telefono'),
                array($this->RenderText('IdBodega'), $this->RenderText('Nombre'), $this->RenderText('Direccion'), $this->RenderText('Ciudad'), $this->RenderText('Telefono')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('bodegaasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idBodega', $this->RenderText('IdBodega')));
        ...
        {
            //
            // View column for idBodega field
            //
            $column = new TextViewColumn('idBodega', 'IdBodega', $this->dataset);
        ...
        {
            $result = new Grid($this, $this->dataset, 'bodegaGrid');
    ...
    try
    {
        $Page = new bodegaPage("bodega.php", "bodega", GetCurrentUserGrantForDataSource("bodega"), 'UTF-8');
        $Page->SetShortCaption('Bodega');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Bodega');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("bodega"));
