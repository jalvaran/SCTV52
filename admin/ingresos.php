 ...
 */
    ...
    class ingresosPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`ingresos`');
            $field = new IntegerField('idIngresos', null, null, true);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('ingresosssearch', $this->dataset,
                array('idIngresos', 'Observaciones', 'Total', 'Fecha', 'Facturas_idFacturas'),
                array($this->RenderText('IdIngresos'), $this->RenderText('Observaciones'), $this->RenderText('Total'), $this->RenderText('Fecha'), $this->RenderText('Facturas IdFacturas')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('ingresosasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idIngresos', $this->RenderText('IdIngresos')));
        ...
        {
            //
            // View column for idIngresos field
            //
            $column = new TextViewColumn('idIngresos', 'IdIngresos', $this->dataset);
        ...
        {
            $result = new Grid($this, $this->dataset, 'ingresosGrid');
    ...
    try
    {
        $Page = new ingresosPage("ingresos.php", "ingresos", GetCurrentUserGrantForDataSource("ingresos"), 'UTF-8');
        $Page->SetShortCaption('Ingresos');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Ingresos');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("ingresos"));
