 ...
 */
    ...
    class prod_sub5Page extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('idSub4', 'prod_sub4', new IntegerField('idSub4', null, null, true), new StringField('NombreSub4', 'idSub4_NombreSub4', 'idSub4_NombreSub4_prod_sub4'), 'idSub4_NombreSub4_prod_sub4');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('prod_sub5ssearch', $this->dataset,
                array('idSub5', 'NombreSub5', 'idSub4_NombreSub4'),
                array($this->RenderText('IdSub5'), $this->RenderText('NombreSub5'), $this->RenderText('IdSub4')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('prod_sub5asearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idSub5', $this->RenderText('IdSub5')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('NombreSub5', $this->RenderText('NombreSub5')));
            ...
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, false);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('idSub4', $this->RenderText('IdSub4'), $lookupDataset, 'idSub4', 'NombreSub4', false));
        }
        ...
        {
            //
            // View column for idSub5 field
            //
            $column = new TextViewColumn('idSub5', 'IdSub5', $this->dataset);
            ...
            //
            $column = new TextViewColumn('NombreSub5', 'NombreSub5', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('NombreSub5_handler');
            
            /* <inline edit column> */
            //
            // Edit column for NombreSub5 field
            //
            $editor = new TextAreaEdit('nombresub5_edit', 50, 8);
            $editColumn = new CustomEditColumn('NombreSub5', 'NombreSub5', $editor, $this->dataset);
            ...
            //
            $column = new TextViewColumn('idSub4_NombreSub4', 'IdSub4', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for idSub4 field
            //
            $editor = new ComboBox('idsub4_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $lookupDataset = new TableDataset(
                new MyConnectionFactory(),
                GetConnectionOptions(),
                '`prod_sub4`');
            ...
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, false);
            $lookupDataset->SetOrderBy('NombreSub4', GetOrderTypeAsSQL(otAscending));
        ...
        {
            $result = new Grid($this, $this->dataset, 'prod_sub5Grid');
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'NombreSub5_handler', $column);
    ...
    try
    {
        $Page = new prod_sub5Page("prod_sub5.php", "prod_sub5", GetCurrentUserGrantForDataSource("prod_sub5"), 'UTF-8');
        $Page->SetShortCaption('Prod Sub5');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Prod Sub5');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("prod_sub5"));
