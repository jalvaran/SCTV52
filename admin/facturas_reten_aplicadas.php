 ...
 */
    ...
    class facturas_reten_aplicadasPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`facturas_reten_aplicadas`');
            $field = new IntegerField('idFacturasRetAplicadas', null, null, true);
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new StringField('Fecha');
            $this->dataset->AddField($field, false);
            $field = new StringField('NombreRetencion');
            $this->dataset->AddField($field, false);
            $field = new StringField('Porcentaje');
            $this->dataset->AddField($field, false);
            $field = new StringField('Monto');
            $this->dataset->AddField($field, false);
            $field = new StringField('Cruzada');
            $this->dataset->AddField($field, false);
            $field = new StringField('FechaCruce');
            $this->dataset->AddField($field, false);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('facturas_reten_aplicadasssearch', $this->dataset,
                array('idFacturasRetAplicadas', 'Fecha', 'NombreRetencion', 'Porcentaje', 'Monto', 'Cruzada', 'FechaCruce', 'Soportes_idSoportes', 'Facturas_idFacturas', 'idImpRet'),
                array($this->RenderText('IdFacturasRetAplicadas'), $this->RenderText('Fecha'), $this->RenderText('NombreRetencion'), $this->RenderText('Porcentaje'), $this->RenderText('Monto'), $this->RenderText('Cruzada'), $this->RenderText('FechaCruce'), $this->RenderText('Soportes IdSoportes'), $this->RenderText('Facturas IdFacturas'), $this->RenderText('IdImpRet')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('facturas_reten_aplicadasasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idFacturasRetAplicadas', $this->RenderText('IdFacturasRetAplicadas')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('NombreRetencion', $this->RenderText('NombreRetencion')));
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('Cruzada', $this->RenderText('Cruzada')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('FechaCruce', $this->RenderText('FechaCruce')));
        ...
        {
            //
            // View column for idFacturasRetAplicadas field
            //
            $column = new TextViewColumn('idFacturasRetAplicadas', 'IdFacturasRetAplicadas', $this->dataset);
            ...
            //
            // View column for NombreRetencion field
            //
            $column = new TextViewColumn('NombreRetencion', 'NombreRetencion', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for NombreRetencion field
            //
            $editor = new TextEdit('nombreretencion_edit');
            $editor->SetSize(45);
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('NombreRetencion', 'NombreRetencion', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
            ...
            //
            // View column for Cruzada field
            //
            $column = new TextViewColumn('Cruzada', 'Cruzada', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for Cruzada field
            //
            $editor = new TextEdit('cruzada_edit');
            $editor->SetSize(2);
            $editor->SetMaxLength(2);
            $editColumn = new CustomEditColumn('Cruzada', 'Cruzada', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
            ...
            //
            // View column for FechaCruce field
            //
            $column = new TextViewColumn('FechaCruce', 'FechaCruce', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for FechaCruce field
            //
            $editor = new TextEdit('fechacruce_edit');
            $editor->SetSize(45);
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('FechaCruce', 'FechaCruce', $editor, $this->dataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            /* </inline edit column> */
        ...
        {
            $result = new Grid($this, $this->dataset, 'facturas_reten_aplicadasGrid');
    ...
    try
    {
        $Page = new facturas_reten_aplicadasPage("facturas_reten_aplicadas.php", "facturas_reten_aplicadas", GetCurrentUserGrantForDataSource("facturas_reten_aplicadas"), 'UTF-8');
        $Page->SetShortCaption('Facturas Reten Aplicadas');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Facturas Reten Aplicadas');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("facturas_reten_aplicadas"));
