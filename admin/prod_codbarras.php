 ...
 */
    ...
    class prod_codbarrasPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('prod_codbarrasssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('prod_codbarrasasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        {
            $result = new Grid($this, $this->dataset, 'prod_codbarrasGrid');
    ...
    try
    {
        $Page = new prod_codbarrasPage("prod_codbarras.php", "prod_codbarras", GetCurrentUserGrantForDataSource("prod_codbarras"), 'UTF-8');
        $Page->SetShortCaption('Prod Codbarras');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Prod Codbarras');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("prod_codbarras"));
