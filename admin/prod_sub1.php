 ...
 */
    ...
    class prod_sub1Page extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('idDepartamento', 'prod_departamentos', new IntegerField('idDepartamentos', null, null, true), new StringField('Nombre', 'idDepartamento_Nombre', 'idDepartamento_Nombre_prod_departamentos'), 'idDepartamento_Nombre_prod_departamentos');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('prod_sub1ssearch', $this->dataset,
                array('idSub1', 'NombreSub1', 'idDepartamento_Nombre'),
                array($this->RenderText('IdSub1'), $this->RenderText('NombreSub1'), $this->RenderText('IdDepartamento')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('prod_sub1asearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idSub1', $this->RenderText('IdSub1')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('NombreSub1', $this->RenderText('NombreSub1')));
            ...
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, false);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('idDepartamento', $this->RenderText('IdDepartamento'), $lookupDataset, 'idDepartamentos', 'Nombre', false));
        }
        ...
        {
            //
            // View column for idSub1 field
            //
            $column = new TextViewColumn('idSub1', 'IdSub1', $this->dataset);
            ...
            //
            $column = new TextViewColumn('NombreSub1', 'NombreSub1', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('NombreSub1_handler');
            
            /* <inline edit column> */
            //
            // Edit column for NombreSub1 field
            //
            $editor = new TextAreaEdit('nombresub1_edit', 50, 8);
            $editColumn = new CustomEditColumn('NombreSub1', 'NombreSub1', $editor, $this->dataset);
            ...
            //
            $column = new TextViewColumn('idDepartamento_Nombre', 'IdDepartamento', $this->dataset);
            $column->SetOrderable(true);
        ...
        {
            $result = new Grid($this, $this->dataset, 'prod_sub1Grid');
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'NombreSub1_handler', $column);
    ...
    try
    {
        $Page = new prod_sub1Page("prod_sub1.php", "prod_sub1", GetCurrentUserGrantForDataSource("prod_sub1"), 'UTF-8');
        $Page->SetShortCaption('Prod Sub1');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Prod Sub1');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("prod_sub1"));
