 ...
 */
    ...
    class prod_sub4Page extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('idSub3', 'prod_sub3', new IntegerField('idSub3', null, null, true), new StringField('NombreSub3', 'idSub3_NombreSub3', 'idSub3_NombreSub3_prod_sub3'), 'idSub3_NombreSub3_prod_sub3');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('prod_sub4ssearch', $this->dataset,
                array('idSub4', 'NombreSub4', 'idSub3_NombreSub3'),
                array($this->RenderText('IdSub4'), $this->RenderText('NombreSub4'), $this->RenderText('IdSub3')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('prod_sub4asearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idSub4', $this->RenderText('IdSub4')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('NombreSub4', $this->RenderText('NombreSub4')));
            ...
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, false);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('idSub3', $this->RenderText('IdSub3'), $lookupDataset, 'idSub3', 'NombreSub3', false));
        }
        ...
        {
            //
            // View column for idSub4 field
            //
            $column = new TextViewColumn('idSub4', 'IdSub4', $this->dataset);
            ...
            //
            $column = new TextViewColumn('NombreSub4', 'NombreSub4', $this->dataset);
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('NombreSub4_handler');
            
            /* <inline edit column> */
            //
            // Edit column for NombreSub4 field
            //
            $editor = new TextAreaEdit('nombresub4_edit', 50, 8);
            $editColumn = new CustomEditColumn('NombreSub4', 'NombreSub4', $editor, $this->dataset);
            ...
            //
            $column = new TextViewColumn('idSub3_NombreSub3', 'IdSub3', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for idSub3 field
            //
            $editor = new ComboBox('idsub3_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $lookupDataset = new TableDataset(
                new MyConnectionFactory(),
                GetConnectionOptions(),
                '`prod_sub3`');
            ...
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, false);
            $lookupDataset->SetOrderBy('NombreSub3', GetOrderTypeAsSQL(otAscending));
        ...
        {
            $result = new Grid($this, $this->dataset, 'prod_sub4Grid');
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'NombreSub4_handler', $column);
    ...
    try
    {
        $Page = new prod_sub4Page("prod_sub4.php", "prod_sub4", GetCurrentUserGrantForDataSource("prod_sub4"), 'UTF-8');
        $Page->SetShortCaption('Prod Sub4');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Prod Sub4');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("prod_sub4"));
