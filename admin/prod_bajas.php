 ...
 */
    ...
    class prod_bajasPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`prod_bajas`');
            $field = new IntegerField('idProd_Bajas', null, null, true);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('prod_bajasssearch', $this->dataset,
                array('idProd_Bajas', 'Fecha', 'Departamento', 'Referencia', 'Nombre', 'Cantidad', 'CostoTotal', 'Observaciones', 'Usuarios_idUsuarios'),
                array($this->RenderText('IdProd Bajas'), $this->RenderText('Fecha'), $this->RenderText('Departamento'), $this->RenderText('Referencia'), $this->RenderText('Nombre'), $this->RenderText('Cantidad'), $this->RenderText('CostoTotal'), $this->RenderText('Observaciones'), $this->RenderText('Usuarios IdUsuarios')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('prod_bajasasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idProd_Bajas', $this->RenderText('IdProd Bajas')));
        ...
        {
            //
            // View column for idProd_Bajas field
            //
            $column = new TextViewColumn('idProd_Bajas', 'IdProd Bajas', $this->dataset);
        ...
        {
            $result = new Grid($this, $this->dataset, 'prod_bajasGrid');
    ...
    try
    {
        $Page = new prod_bajasPage("prod_bajas.php", "prod_bajas", GetCurrentUserGrantForDataSource("prod_bajas"), 'UTF-8');
        $Page->SetShortCaption('Prod Bajas');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Prod Bajas');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("prod_bajas"));
