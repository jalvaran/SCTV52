 ...
 */
    ...
    class col_registrohorasPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`col_registrohoras`');
            $field = new IntegerField('IdColRegistro', null, null, true);
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new IntegerField('IdColaborador');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new StringField('RegistroFecha');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new StringField('RegistroHora');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new StringField('EntradaSalida');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('IdColaborador', 'colaboradores', new IntegerField('idColaboradores', null, null, true), new StringField('Nombre', 'IdColaborador_Nombre', 'IdColaborador_Nombre_colaboradores'), 'IdColaborador_Nombre_colaboradores');
        }
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('col_registrohorasssearch', $this->dataset,
                array('IdColRegistro', 'IdColaborador_Nombre', 'RegistroFecha', 'RegistroHora', 'EntradaSalida'),
                array($this->RenderText('IdColRegistro'), $this->RenderText('IdColaborador'), $this->RenderText('RegistroFecha'), $this->RenderText('RegistroHora'), $this->RenderText('EntradaSalida')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('col_registrohorasasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('IdColRegistro', $this->RenderText('IdColRegistro')));
            ...
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, false);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('IdColaborador', $this->RenderText('IdColaborador'), $lookupDataset, 'idColaboradores', 'Nombre', false));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('RegistroFecha', $this->RenderText('RegistroFecha')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('RegistroHora', $this->RenderText('RegistroHora')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('EntradaSalida', $this->RenderText('EntradaSalida')));
        }
        ...
        {
            //
            // View column for IdColRegistro field
            //
            $column = new TextViewColumn('IdColRegistro', 'IdColRegistro', $this->dataset);
            ...
            //
            $column = new TextViewColumn('IdColaborador_Nombre', 'IdColaborador', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for IdColaborador field
            //
            $editor = new ComboBox('idcolaborador_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $lookupDataset = new TableDataset(
                new MyConnectionFactory(),
                GetConnectionOptions(),
                '`colaboradores`');
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'IdColaborador', 
                $editor, 
                $this->dataset, 'idColaboradores', 'Nombre', $lookupDataset);
            ...
            //
            // View column for RegistroFecha field
            //
            $column = new TextViewColumn('RegistroFecha', 'RegistroFecha', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for RegistroFecha field
            //
            $editor = new TextEdit('registrofecha_edit');
            $editor->SetSize(45);
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('RegistroFecha', 'RegistroFecha', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            ...
            //
            // View column for RegistroHora field
            //
            $column = new TextViewColumn('RegistroHora', 'RegistroHora', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for RegistroHora field
            //
            $editor = new TextEdit('registrohora_edit');
            $editor->SetSize(20);
            $editor->SetMaxLength(20);
            $editColumn = new CustomEditColumn('RegistroHora', 'RegistroHora', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
            ...
            //
            // View column for EntradaSalida field
            //
            $column = new TextViewColumn('EntradaSalida', 'EntradaSalida', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for EntradaSalida field
            //
            $editor = new TextEdit('entradasalida_edit');
            $editor->SetSize(5);
            $editor->SetMaxLength(5);
            $editColumn = new CustomEditColumn('EntradaSalida', 'EntradaSalida', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $column->SetEditOperationColumn($editColumn);
        ...
        {
            $result = new Grid($this, $this->dataset, 'col_registrohorasGrid');
    ...
    try
    {
        $Page = new col_registrohorasPage("col_registrohoras.php", "col_registrohoras", GetCurrentUserGrantForDataSource("col_registrohoras"), 'UTF-8');
        $Page->SetShortCaption('Col Registrohoras');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Col Registrohoras');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("col_registrohoras"));
