 ...
 */
    ...
    class comisionesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`comisiones`');
            $field = new IntegerField('idComisiones', null, null, true);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('comisionesssearch', $this->dataset,
                array('idComisiones', 'Descripcion', 'Porcentaje'),
                array($this->RenderText('IdComisiones'), $this->RenderText('Descripcion'), $this->RenderText('Porcentaje')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('comisionesasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('idComisiones', $this->RenderText('IdComisiones')));
        ...
        {
            //
            // View column for idComisiones field
            //
            $column = new TextViewColumn('idComisiones', 'IdComisiones', $this->dataset);
        ...
        {
            $result = new Grid($this, $this->dataset, 'comisionesGrid');
    ...
    try
    {
        $Page = new comisionesPage("comisiones.php", "comisiones", GetCurrentUserGrantForDataSource("comisiones"), 'UTF-8');
        $Page->SetShortCaption('Comisiones');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Comisiones');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("comisiones"));
