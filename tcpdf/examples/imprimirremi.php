...
////////////////////////////////////////////
		  ...
		  ////////////////////////////////////////////
/////////////registro la remision en la base de datos
////////////////////////////////////////////
			if(isset($_POST["TxtObservacionesRemi"]) && !empty($_POST["TxtObservacionesRemi"]))
				$Observaciones=$_POST["TxtObservacionesRemi"];
		  	else
				$Observaciones=" ";
		  $sql="INSERT INTO `remisiones` ( `Fecha`, `Cliente`, `Observaciones`, `Cotizaciones_idCotizaciones`) 
				VALUES ( '$fecha', '$nombre', '$Observaciones', '$IDCoti');";
		  
		 mysql_query($sql,$con) or die("Problemas al registrar la remision en la base de datos");
		 
		  $Sal = mysql_query("SELECT MAX(idRemisiones) as MaxItem FROM remisiones",$con) or die("Problemas en la consulta a remisiones");	
$Sal = mysql_fetch_array($Sal);
$idRemisiones=$Sal["MaxItem"];
...
<span style="color:#00008B;font-family:'Bookman Old Style';font-size:13px;"><strong><em>REMISIÓN No. $idRemisiones 
</em></strong></span></div>
...
<span style="color:#00008B;font-family:'Bookman Old Style';font-size:13px;"><strong><em>SOLICITUD No.:  </em></strong></span><span style="color:#000000;font-family:'Bookman Old Style';font-size:13px;">$NumSolicitud</span></div>
...
<table border="1"  cellpadding="1" cellspacing="1" align="center" style="border-left: 3px solid #000099;
 ...
 <tr nobr="true">
  ...
  <th  style= "border: 2px solid #000099;"><h3>Valor Unitario</h3></th><th style= "border: 2px solid #000099;"><h3>Total</h3></th>
 </tr>
 </table>
EOD;
...
<span style="color:#00008B;font-family:'Bookman Old Style';font-size:13px;"><strong><em>Valor total de la Cotización: </em></strong></span>
<span style="color:#000000;font-family:'Bookman Old Style';font-size:13px;"><strong><em>$$SubTotal</em></strong></span></br>
 
 <div id="wb_Text6" style="position:absolute;left:35px;top:150px;width:242px;height:18px;z-index:8;text-align:rigth;">
<span style="color:#00008B;font-family:'Bookman Old Style';font-size:13px;"><strong><em>I.V.A No Incluido </em></strong></span><br><br><br>

<div id="wb_Text6" style="position:absolute;left:35px;top:150px;width:242px;height:18px;z-index:8;text-align:left;">
<span style="color:#00008B;font-family:'Bookman Old Style';font-size:10px;"><strong><em> $_POST[TxtObservacionesRemi]
</em></strong></span></div>
