...
$pdf->SetTitle('Nota Contable TS');
$pdf->SetSubject('Nota Contable');
$pdf->SetKeywords('Techno Soluciones, PDF, Nota Contable, CCTV, Alarmas, Computadores, Software');
...
<span style="font-family:'Bookman Old Style';font-size:13px;"><strong><em>NOTA DE CONTABILIDAD No. $idComprobante
</em></strong></span></div>
</div>
EOD;
