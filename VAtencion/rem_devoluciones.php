...
include_once("Configuraciones/rem_devoluciones.ini.php");  //Clases de donde se escribirán las tablas
...
///////////////Creamos la imagen representativa de la pagina
    /////
    /////	
$css->CrearImageLink("../VMenu/Menu.php", "../images/devolucion.png", "_self",200,200);
...
$Consulta=$obVenta->Query("SELECT SUM(Total) as Total FROM $statement");
$DatosD=$obVenta->FetchArray($Consulta);

$Total=  number_format($DatosD["Total"]);
$css->CrearTabla();
$css->CrearFilaNotificacion("Total en Devoluciones = $Total", 16);
$css->CerrarTabla();
